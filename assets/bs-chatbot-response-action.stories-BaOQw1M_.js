import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{a as n,i as r}from"./iframe-B9Mpa5Rp.js";import{n as i,r as a,t as o}from"./stories-utils-CW0P0Irj.js";var s=t({Default:()=>l,InResponseMessage:()=>d,NoSources:()=>u,WithMenu:()=>h,__namedExportsOrder:()=>g,default:()=>c}),c,l,u,d,f,p,m,h,g;function _(){return(_=e((()=>{r(),i(),c={title:`Genie AI Components/bs-chatbot-response-action`,parameters:{docs:{description:{component:o(`bs-chatbot-response-action`)}}},render:e=>n` <bs-chatbot-response-action sources-count=${e.sourcesCount||void 0}></bs-chatbot-response-action> `,argTypes:{sourcesCount:{control:`number`,description:a(`bs-chatbot-response-action`,`sources-count`)}},args:{sourcesCount:3}},l={},u={name:`Without sources`,args:{sourcesCount:0}},d={name:`In an AI response message`,render:()=>n`
...
`,h={name:`More options menu`,render:()=>n`
      <div style="max-width: 480px; font-family: sans-serif;">
        <bs-chatbot-response-action sources-count="3" @bsMenuOpen=${e=>{e.target.menuOpen=e.detail}}>
          <bs-menu slot="menu" style="width: 210px;">
            <bs-menu-item>${f()}Read aloud</bs-menu-item>
            <bs-menu-item>${p()}Chat with a human</bs-menu-item>
            <bs-menu-item>${m()}Raise a ticket</bs-menu-item>
          </bs-menu>
...
}`,...h.parameters?.docs?.source}}},g=[`Default`,`NoSources`,`InResponseMessage`,`WithMenu`]})))()}export{s as a,h as i,d as n,_ as o,u as r,l as t};